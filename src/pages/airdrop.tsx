...
const AirDrop: NextPage = () => {
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex flex-col sm:mx-96 sm:mt-32 items-center sm:mb-16'>
        <div>
      ...
      <div className='flex sm:mx-96 sm:mb-16 airdrop-free'>
        How to get this<span className='about-text-blue-light italic'>&nbsp;FREE&nbsp;</span>airdrop?
      </div>
      <div className='flex flex-col sm:mx-96 airdrop-free-description'>
