...
const AirDrop: NextPage = () => {
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex flex-col 2xl:mx-60 xl:mx-36 lg:mx-16 md:mx-6 sm:mt-32 items-center sm:mb-16'>
        <div>
      ...
      <div className='flex flex-col 2xl:mx-60 xl:mx-36 lg:mx-16 md:mx-6 items-center airdrop-split sm:mb-16'>
      </div>
      <div className='flex 2xl:mx-60 xl:mx-36 lg:mx-16 md:mx-6 sm:mb-16 airdrop-free'>
        How to get this<span className='about-text-blue-light italic'>&nbsp;FREE&nbsp;</span>airdrop?
      </div>
      <div className='flex flex-col 2xl:mx-60 xl:mx-36 lg:mx-16 md:mx-6 airdrop-free-description'>
